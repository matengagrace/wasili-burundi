...
function DownloadAppSection({ videoPosterSrc = downloadAppPoster, videoSrc = downloadAppVideo}) {
          ...
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">
                Télécharger l'application Wasili
              </h2>
              <p className="mb-8 max-w-lg text-PRIMARY-COLOR text-lg">
                Voici comment procéder pour télécharger l'application Wasili sur
                votre smartphone
              </p>
              <button
                type="button"
