...
function CommanderSection({ videoPosterSrc = commanderAppPoster, videoSrc = commanderAppVideo, language = "fr" }) {
  const [isPlaying, setIsPlaying] = useState(false);
  const t = siteTranslations[language]?.commander ?? siteTranslations.fr.commander;
